...
const client = createClient({
  baseUrl: 'https://pzv974n7.us-east.insforge.app',  // Your InsForge backend URL
  anonKey: 'your-anon-key-here'       // Get this from backend metadata
});

```

**API BASE URL**: Your API base URL is `https://pzv974n7.us-east.insforge.app`.
...
## AgentRabbit Linked Backend Notes

- Project: `RobotRabbit`
- API base URL: `https://pzv974n7.us-east.insforge.app`
- Saved MCP docs note: `docs/insforge/mcp-instructions.md`
- This project should reference users with `auth.users(id)` and use `auth.uid()` in RLS policies.
- Keep InsForge API keys and app secrets out of committed files.
